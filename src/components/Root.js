                ...
                <div className="container-fluid d-flex h-100 p-0 mx-auto flex-column fuel-spot-bg">
                    ...
                    <footer className="mastfoot mt-auto">
                        <nav class="nav nav-masthead justify-content-start btn-group">
                            <NavLink exact={true} activeClassName='is-active' className="btn btn-fuelspot"
                                     to="/login">Giriş</NavLink>
                            <NavLink activeClassName='is-active' className="btn btn-fuelspot"
                                     to="/privacy">Gizlilik</NavLink>
                            <NavLink activeClassName='is-active' className="btn btn-fuelspot" to="/termsandconditions">Kullanım
                                Şartları</NavLink>
                        </nav>
                    </footer>
                </div>
        ...
        return (
            <div className="col col-sm-6 mx-auto text-white">
                ...
                <p>
                    ...
                    Other than the content you own, under these Terms, FuelSpot and/or its licensors own all the
                    ...
                    Certain areas of this Website are restricted from being access by you and FuelSpot may further
                    ...
                    grant FuelSpot a non-exclusive, worldwide irrevocable, sub licensable license to use, reproduce,
                    adapt, publish, translate and distribute it in any and all media.

                    Your Content must be your own and must not be invading any third-party's rights. FuelSpot reserves
                    the right to remove any of Your Content from this Website at any time without notice.

                    No warranties
                    This Website is provided “as is,” with all faults, and FuelSpot express no representations or
                    ...
                    In no event shall FuelSpot, nor any of its officers, directors and employees, shall be held liable
                    for anything arising out of or in any way connected with your use of this Website whether such
                    liability is under contract. FuelSpot, including its officers, directors and employees shall not be
                    ...
                    Indemnification
                    You hereby indemnify to the fullest extent FuelSpot from and against any and/or all liabilities,
                    ...
                    Variation of Terms
                    FuelSpot is permitted to revise these Terms at any time as it sees fit, and by using this Website
                    you are expected to review these Terms on a regular basis.

                    Assignment
                    The FuelSpot is allowed to assign, transfer, and subcontract its rights and/or obligations under
                    ...
                    Entire Agreement
                    These Terms constitute the entire agreement between FuelSpot and you in relation to your use of this
                    ...
                    <div className="card-body">
                        ...
                        <div className="row">
                            ...
                            <div className="col-4 text-center">
                                <img src={this.state.photo || this.state.user.photo} id="FUELSPOT_UPLOAD"
                            ...
                            <div className="col-8">
                                ...
                                <div className="p-4">
                                    ...
                                    <div className="form-group">
                                        ...
                                        <button className="btn btn-primary" onClick={this.fileUploadHandler}>UPLOAD
                                        </button>
                                    </div>
                                    ...
                                    <div className="form-group">
                                        ...
                                        <input name="plateNo" type="text" className="form-control"
                                               onChange={this.handleInputChange} placeholder=""/>
                                    </div>

                                    <div className="form-group">
                                        <label>İstasyon Adresi</label>
                                        <input name="kilometer" type="text" onChange={this.handleInputChange}
                                               className="form-control" placeholder=""/>
                                        <small id="emailHelp" class="form-text text-muted">Bilgileri kimseyle
                                            paylaşmayacağız.
                                        </small>
                                    </div>
                                    ...
                                    <div className="form-group">
                                        ...
                                        <input name="kilometer" type="text" onChange={this.handleInputChange}
                                               className="form-control" placeholder="BAY/XXX-XX/XXXXX"/>
                                        <small id="emailHelp" class="form-text text-muted">Bilgileri kimseyle
                                            paylaşmayacağız.
                                        </small>
                                    </div>
                                    ...
                                    <div className="form-group">
                                        ...
                                        <input name="namesurname" type="text" onChange={this.handleInputChange}
                                               className="form-control" placeholder=""/>
                                    </div>
                                    <div className="form-group">
                                        <label>E-posta</label>
                                    ...
                                    <div className="form-group">
                                        <label>Telefon</label>
                                        <input name="tel" type="text" onChange={this.handleInputChange}
                                               className="form-control" placeholder=""/>
                                    </div>
                                    ...
                                    <div className="form-group">
                                        ...
                                        <div className="form-check form-check-inline">
                                            <input class="form-check-input" onChange={this.handleInputChange}
                                                   type="radio" name="fuelPri" id="fuelPri_1" defaultValue="erkek"/>
                                            <label class="form-check-label" for="fuelPri_1">Erkek</label>
                                        </div>
                                        <div className="form-check form-check-inline">
                                            <input class="form-check-input" onChange={this.handleInputChange}
                                                   type="radio" name="fuelPri" id="fuelPri_2" defaultValue="kadin"/>
                                            <label class="form-check-label" for="fuelPri_2">Kadın</label>
                                        </div>
                                        <div className="form-check form-check-inline">
                                            <input class="form-check-input" onChange={this.handleInputChange}
                                                   type="radio" name="fuelPri" id="fuelPri_3" defaultValue="woman"/>
                                ...
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="exampleCheck1">Kullanım şartlarını ve üyelik
                                        anlaşmasını kabul ediyorum.</label>
                                </div>

                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input" id="exampleCheck1"/>
                                    <label class="form-check-label" for="exampleCheck1">Veri kullandırma şartlarını
                            ...
                            <div className="col-8">
                                ...
                                <div className="p-4">
                                    ...
                                    <div className="form-group">
                                        ...
                                        <select name="brand" className="form-control" onChange={this.handleInputChange}
                                                defaultValue="">
                                        ...
                                        <select name="model" className="form-control" onChange={this.handleInputChange}
                                                defaultValue="">
                                    ...
                                    <div className="form-group">
                                        ...
                                        <input name="plateNo" type="text" className="form-control"
                                               onChange={this.handleInputChange} placeholder="16 U 1320"/>
                                    </div>

                                    <div className="form-group">
                                        <label>Araç KM Bilgisi</label>
                                        <input name="kilometer" min="0" step="1000" type="number"
                                    ...
                                    <div className="form-group">
                                        ...
                                        <div className="form-check form-check-inline">
                                            <input class="form-check-input" onChange={this.handleInputChange}
                                                   type="radio" name="fuelPri" id="fuelPri_1" defaultValue="gasoline"/>
                                            <label class="form-check-label" for="fuelPri_1">Benzin</label>
                                        </div>
                                        <div className="form-check form-check-inline">
                                            <input class="form-check-input" onChange={this.handleInputChange}
                                                   type="radio" name="fuelPri" id="fuelPri_2" defaultValue="diesel"/>
                                            <label class="form-check-label" for="fuelPri_2">Dizel</label>
                                        </div>
                                        <div className="form-check form-check-inline">
                                            <input class="form-check-input" onChange={this.handleInputChange}
                                                   type="radio" name="fuelPri" id="fuelPri_3" defaultValue="lpg"/>
                                            <label class="form-check-label" for="fuelPri_3">LPG</label>
                                        </div>
                                        <div className="form-check form-check-inline">
                                            <input class="form-check-input" onChange={this.handleInputChange}
                                                   type="radio" name="fuelPri" id="fuelPri_4"
                                    ...
                                    <div className="form-group" id="ikincil">
                                        ...
                                        <div className="form-check form-check-inline">
                                            <input class="form-check-input" onChange={this.handleInputChange}
                                                   type="radio" name="fuelSec" id="fuelSec_1" value="gasoline"/>
                                            <label class="form-check-label" for="fuelSec_1">Benzin</label>
                                        </div>
                                        <div className="form-check form-check-inline">
                                            <input class="form-check-input" onChange={this.handleInputChange}
                                                   type="radio" name="fuelSec" id="fuelSec_2" value="diesel"/>
                                            <label class="form-check-label" for="fuelSec_2">Dizel</label>
                                        </div>
                                        <div className="form-check form-check-inline">
                                            <input class="form-check-input" onChange={this.handleInputChange}
                                                   type="radio" name="fuelSec" id="fuelSec_3" value="lpg"/>
                                            <label class="form-check-label" for="fuelSec_3">LPG</label>
                                        </div>
                                        <div className="form-check form-check-inline">
                                            <input class="form-check-input" onChange={this.handleInputChange}
                                                   type="radio" name="fuelSec" id="fuelSec_4" value="electricity"/>
                ...
                <div className="container-fluid d-flex h-100 p-0 mx-auto flex-column">
                    <header class="masthead mb-auto">
                        <div class="inner">
                            ...
                            <nav class="nav nav-masthead justify-content-start btn-group">
                                <NavLink exact={true} activeClassName='is-active' className="btn btn-fuelspot"
                                         to="/">İstasyonlar</NavLink>
                                <NavLink activeClassName='is-active' className="btn btn-fuelspot"
                                         to="/news">Güncel</NavLink>
                                <NavLink activeClassName='is-active' className="btn btn-fuelspot"
                                         to="/vehicles">Aracım</NavLink>
                                <NavLink activeClassName='is-active' className="btn btn-fuelspot"
        ...
        return (
            <div className="col col-sm-6 mx-auto text-white">
                ...
                <p>
                    ...
                    Services provided by FuelSpot (“us”, “we”, or “our”) include all our websites and all our mobile
                    applications on all platforms (the “Service”). This page informs you of our policies regarding the
                    collection, use and disclosure of Personal Information and Non-Personal Information we receive from
                    users of the Service. By using the Service, you agree to the collection and use of information in
                    accordance with this policy.
                    What information we collect
                    Personal Information
                    Personal Information is information that identifies you or another person, which may be transmitted
                    or received when you use the Service. We do NOT collect any Personal Information.

                    Non-Personal Information
                    Like many online services, we collect information that your browser or phone sends whenever you use
                    our Service (“Log Data”). This Log Data may include information such as your device Internet
                    Protocol (“IP”) address, type, version, the pages of our Service that you visit, the time and date
                    ...
                    Non-Personal Information. Generally non-personal information is used internally to monitor and
                    improve the Service, to perform analyses of the behavior of our users, to measure user demographics
                    and interests, to describe our services to third parties such as advertisers and to analyze how and
                    where best to use our resources. We do not combine Non-Personal Information with Personal
                    Information.

                    How we share the information we collect
                    Personal Information. We do NOT collect and share Personal Information in any way.

                    Non-Personal Information. We accept advertisements from Third Parties ad networks which may be
                    displayed in our Service. We may share certain information with third-party advertisers, ad networks
                    and ad platforms (“Advertising Entities”) to develop and deliver targeted advertising in the
                    Service. We may also allow Advertising Entities to collect non-personal information within the
                    Services which they may share with us, including your device identifier, device type, device brand,
                    device model, network type, device language, and IP address. Advertising entities may also collect
                    non-personal information related to the performance of the advertisements, such as how many times an
                    advertisement is shown, how long an advertisement is viewed, and any click-throughs of an
                    advertisement.

                    Links to third-party websites and services
                    The Service may contain links to other websites and online services, including third-party
                    advertisements. If you choose to click through to one of these other websites or online services,
                    please note that any information you may provide will be subject to the privacy policy and other
                    terms and conditions of that websites or service, and not to this Privacy Policy. We do not control
                    third-party websites or services, and the fact that a link to such a website or service appears in
                    the Service does not mean that we endorse them or have approved their policies or practices relating
                    to user information. Before providing any information to any third-party website or service, we
                    encourage you to review the privacy policy and other terms and conditions of that website or
                    service.

                    Although we don’t collect any Personal Information, the Service use third party services, which may
                    do so. These services are:

                    Google Admob & Google Analytics Their privacy policy can be found here:
                    http://www.google.com/policies/privacy/

                    Facebook Audience Network Their privacy policy can be found here:
                    https://www.facebook.com/privacy/explanation

                    Security
                    We take reasonable measures to maintain the security and integrity of our Service and prevent
                    unauthorized access to it or use thereof through generally accepted industry standard technologies
                    and internal procedures. Please note, however, that there are inherent risks in transmission of
                    information over the Internet or other methods of electronic storage and we cannot guarantee that
                    unauthorized access or use will never occur.

                    Compliance with laws and law enforcement
                    We reserve the right to share your information with third parties if we believe such action is
                    necessary in order to: (1) conform with the requirements of the law or to comply with legal process
                    served upon us; (2) protect or defend our legal rights or property (3) investigate, prevent or take
                    action regarding illegal activities, suspected fraud, situations involving potential threats to the
                    physical safety of any person or violations of the terms and conditions of using our Service.

                    Changes to this privacy policy
                    We may update this Privacy Policy from time to time. We will notify you of any changes by posting
                    the new Privacy Policy on the Service. You are advised to review this Privacy Policy periodically
                    for any changes. Your continued use of the Service following the posting of changes will mean you
                    accept those changes.

                    Contacting us
                    If you have any questions or comments about this Policy or our privacy practices, or to report any
                    violations of the Policy or abuse of the Service, please contact us at info@fuel-spot.com
                </p>
            </div>
        )
    }
